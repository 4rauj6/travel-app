# travel-app
A App/Web (POC) developed by João Victor "4rauj6" Araújo. Featuring William "williamzim" Davisson and Alan "Duck" Kauê. This repository has as it's main goal to show the author's habilities in building the Front-End resources on this academic software. 
...
<p>As you can see in the "Assets" folder, this aplication has utilized third-party resources provided by royalty-free image websites, like Freepik (now Magnific) <br><br>Link to the WebSite: (https://www.freepik.com/log-in?client_id=freepik&lang=en&cb_url=https%3A%2F%2Fwww.freepik.com%2Fhome-auth). <br><br>This doens't deny the credits to the resoucers authentics authors and all the credits are reserved by its original creators. All the assets in the software was created by Freepik.</p>
